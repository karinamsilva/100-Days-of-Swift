...
class ViewController: UIViewController {
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        ac.dismiss(animated: true, completion: {
            let final = UIAlertController(title: "Ending", message: "Your Final score \(self.score)", preferredStyle: .alert)
            final.addAction(UIAlertAction(title: "Finish", style: .cancel, handler: nil))
